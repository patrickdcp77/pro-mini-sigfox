...
#define PIN_HX711_N1_DATA_OUT 4 // connexion auDATA
...
const unsigned int MAX_COUNTER_POWER_DOWN_WAKE_UP = 116 ; // MUST BE >=2 , 116 for 15mnsNumber of WATCH DOG before starting the main software  
...
boolean DEBUG_MODE =  0; // =1 for debbug , then ALLOW BLINKING LED and statement on Serial Monitor throught SERIAL RX/TX UART0  
